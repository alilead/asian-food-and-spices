...
export const translations: Translations = {
  ...
  cartEmptyDesc: { fr: "Découvrez nos produits et ajoutez-les à votre panier.", en: "Discover our products and add them to your cart." },
  ...
  viewAllProductsButton: { fr: "Voir tous les produits", en: "View All Products" },
  productNotFound: { fr: "Produit non trouvé", en: "Product not found" },
  productGuarantee: { fr: "Produit authentique importé directement d'Asie. Qualité garantie.", en: "Authentic product imported directly from Asia. Quality guaranteed." },
  visitUs: { fr: "Nous visiter", en: "Visit Us" },
  sinceGeneva: { fr: "Depuis 2015 à Genève", en: "Since 2015 in Geneva" },
  ourCommitment: { fr: "Notre engagement", en: "Our Commitment" },
  discover: { fr: "Découvrez", en: "Discover" },
  selection: { fr: "Sélection", en: "Selection" },
  madeWithPassion: { fr: "Fait avec passion à Genève", en: "Made with passion in Geneva" },
  footerTagline: { fr: "Épicerie asiatique à Genève", en: "Asian grocery in Geneva" },
  exclusiveOffers: { fr: "Offres exclusives", en: "Exclusive offers" },
  authenticRecipes: { fr: "Recettes authentiques", en: "Authentic recipes" },
  newArrivals: { fr: "Nouveaux arrivages", en: "New arrivals" },
  privacyNote: { fr: "Nous respectons votre vie privée. Désabonnement à tout moment.", en: "We respect your privacy. Unsubscribe anytime." },
  contactIntro: { fr: "Une question ? Nous sommes là pour vous aider. Contactez-nous par email, téléphone ou venez nous rendre visite !", en: "Have a question? We are here to help. Contact us by email, phone, or visit us!" },
  ...
  messageSent: { fr: "Message envoyé !", en: "Message sent!" },
  messageSentDesc: { fr: "Nous vous répondrons dans les plus brefs délais.", en: "We will respond to you as soon as possible." },
  addressLabel: { fr: "Adresse", en: "Address" },
  deliveryToAddress: { fr: "Livraison à votre adresse", en: "Delivery to your address" },
  authenticProducts: { fr: "Produits authentiques", en: "Authentic Products" },
  countriesOfOrigin: { fr: "Pays d'origine", en: "Countries of Origin" },
  yearsOfExpertise: { fr: "Ans d'expertise", en: "Years of Expertise" },
  processing: { fr: "Traitement...", en: "Processing..." },
  productAdded: { fr: "Produit ajouté !", en: "Product added!" },
  addedToCartSuffix: { fr: "a été ajouté au panier", en: "has been added to cart" },
  addedToCartWithQty: { fr: "ajouté au panier", en: "added to cart" },
  welcomeToast: { fr: "Bienvenue !", en: "Welcome!" },
  welcomeToastDesc: { fr: "Vous êtes maintenant inscrit à notre newsletter.", en: "You are now subscribed to our newsletter." },
};
